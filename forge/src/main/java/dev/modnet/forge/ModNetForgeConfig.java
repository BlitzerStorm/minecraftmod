...
final class ModNetForgeConfig {
    ...
    private ModNetForgeConfig(boolean udpEnabled, int udpPort, int udpPortMin, int udpPortMax, int udpMaxPayloadBytes, int udpCompressionThresholdBytes,
    ...
    static ModNetForgeConfig load() {
        ...
        return new ModNetForgeConfig(udpEnabled, udpPort, udpPortMin, udpPortMax, udpMaxPayload, udpCompressionThreshold, udpRateLimitPerSecond,
